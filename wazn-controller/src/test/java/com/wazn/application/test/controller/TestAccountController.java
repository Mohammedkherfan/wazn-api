...
public class TestAccountController {
    ...
    public void whenAddMeeting_ThenReturnMeetingThatAdded() throws Exception {
        mockMvc.perform(post("/wazn/accounts/+962798988910/addMeeting").content(asJsonString(new AddMeetingScheduleRequest(LocalDateTime.now().plusDays(1), LocalDateTime.now().plusDays(1), "note"))).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isCreated());
    }
